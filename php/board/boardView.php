    ...
    <main id="contents">
        ...
        <section id="board-type" class="section center mb100">
            <div class="container">
                ...
                <p class="section__desc">수업과 관련된 게시글을 볼 수 있습니다.</p>
                    ...
                    <div class="board__table">
                        <table>
                            ...
                            <tbody>
                             ...
                             $sql = "SELECT boardTitle, m.youName, b.regTime, b.boardView, boardContents FROM myBoard b JOIN myMember m ON(m.memberID = b.memberID) WHERE b.boardID = {$boardID}";
