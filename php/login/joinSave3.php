...
<body>
    ...
    <!-- //header -->
        ...
        <?php
            ...
            // $check_email = preg_match("/^[_\.0-9a-zA-Z]*@")
            ...
            //이메일 목록 가져오기
            $sql = "SELECT youEmail FROM myMember3 WHERE youEmail = '$youEmail'";
            ...
            //핸드폰 번호 목록 가져오기
            $sql = "SELECT youPhone FROM myMember3 WHERE youPhone = '$youPhone'";
            $result = $connect -> query($sql);
            ...
            if($isEmailCheck = true && $isPhoneCheck = true){
                $sql = "INSERT INTO myMember3(youEmail, youPass, youPassC, youName, youBirth, youPhone, regTime) VALUES('$youEmail', '$youPass', '$youPassC', '$youName', '$youBirth', '$youPhone', '$regTime')";
                $result = $connect -> query($sql);
